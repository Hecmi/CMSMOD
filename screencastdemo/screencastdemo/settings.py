"""
Django settings for screencastdemo project.
...
SECRET_KEY = 'django-insecure-^e)#8zc@)atf)t)==-7-)u#p9ted(em*c7row8pr4w_g2$u56^'
...
ROOT_URLCONF = 'screencastdemo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "screencastdemo", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'screencastdemo.wsgi.application'
...
PARLER_LANGUAGES = {
    None: (
        {'code': 'en'},
        {'code': 'es'},
        # Add any other language codes here
    ),
    'default': {
        'fallback': 'en',
        'hide_untranslated': False,
...
STATICFILES_DIRS = [
    BASE_DIR / "screencastdemo" / "static",
]
