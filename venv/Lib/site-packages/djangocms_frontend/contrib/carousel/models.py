...
class Carousel(FrontendUIItem):
    ...
    def get_short_description(self):
        ...
        text += " {}: {}".format(_("Intervalos"), self.carousel_interval)
        text += ", {}: {}".format(_("Controles"), self.carousel_controls)
        text += ", {}: {}".format(_("Indicadores"), self.carousel_indicators)
        text += ", {}: {}".format(_("Teclado"), self.carousel_keyboard)
        text += ", {}: {}".format(_("Pause"), self.carousel_pause)
        text += ", {}: {}".format(_("Viaje"), self.carousel_ride)
        text += ", {}: {}".format(_("Ajuste"), self.carousel_wrap)
        return text
...
class CarouselSlide(GetLinkMixin, ImageMixin, FrontendUIItem):
    ...
    class Meta:
        proxy = True
        verbose_name = _("Elemento de carrusel")
