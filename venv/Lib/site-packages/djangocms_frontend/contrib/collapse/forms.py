...
class CollapseForm(mixin_factory("Collapse"), EntangledModelForm):
    ...
    collapse_siblings = forms.CharField(
        ...
        initial=".card",
        required=False,
        help_text=_("Elemento que será usado para crear los acordeones."),
    )
...
class CollapseTriggerForm(mixin_factory("CollapseTrigger"), EntangledModelForm):
    ...
    trigger_identifier = forms.SlugField(
        label=_("Identificador único"),
        required=True,
        help_text=_("Identificador de la conexión con el disparador de su contenedor."),
    )
    attributes = AttributesFormField()
    tag_type = TagTypeFormField()
