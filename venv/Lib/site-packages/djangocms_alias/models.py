...
class Alias(models.Model):
    ...
    static_code = models.CharField(
        verbose_name=_('Código estático'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('Para renderizar el alias en las plantillas.')
    )
...
class AliasContent(models.Model):
    ...
    class Meta:
        verbose_name = _('Contenido de alias')
        verbose_name_plural = _('Contenidos de alias')
...
class AliasPlugin(CMSPlugin):
    ...
    class Meta:
        verbose_name = _('Plugin de alias')
        verbose_name_plural = _('Plugins alias')
