...
<p class="errornote">
{% blocktranslate count counter=form.errors.items|length %}Por favor corrige el sigueinte error.{% plural %}Por favor corrija los siguientes errores.{% endblocktranslate %}
</p>
{% endif %}
