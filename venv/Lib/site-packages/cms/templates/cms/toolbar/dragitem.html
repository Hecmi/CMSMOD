    ...
    <div class="cms-dragitem cms-dragitem-handler
        ...
        {% if not disabled_child %}
            <div class="cms-submenu-btn cms-submenu-edit cms-btn" data-rel="edit">
                <span class="cms-hover-tooltip cms-hover-tooltip-left cms-hover-tooltip-delay" data-cms-tooltip="{% trans "Editar" %}"></span>
            </div>
            <div class="cms-submenu-btn cms-submenu-add cms-btn
                {% if not allow_children %} cms-btn-disabled{% endif %}">
                {% if not allow_children %}
                <span class="cms-hover-tooltip" data-cms-tooltip="{% trans "No pudes añadir plugins a este plugin." %}"></span>
                {% else %}
                <span class="cms-hover-tooltip cms-hover-tooltip-left cms-hover-tooltip-delay" data-cms-tooltip="{% trans "Añadir plugin" %}"></span>
                {% endif %}
            </div>
        ...
        {% else %}
            <div class="cms-hover-tooltip cms-hover-tooltip-left cms-plugin-disabled" tabindex="-1"
                data-cms-tooltip="{% trans "Este plugin no puede moverse o ser editado fuera de su padre" %}">
        ...
        <div class="cms-submenu-dropdown cms-submenu-dropdown-settings">
            <div class="cms-dropdown-inner">
                <div class="cms-submenu-item"><a data-cms-icon="cut" data-rel="cut" href="#">{% trans "Cortar" %}</a></div>
                <div class="cms-submenu-item"><a data-cms-icon="copy" data-rel="copy" href="#">{% trans "Copiar" %}</a></div>
                <div class="cms-submenu-item">
                    <a data-cms-icon="paste" data-rel="paste" href="#">{% trans "Paste" %}</a>
                    <span class="cms-submenu-item-paste-tooltip cms-submenu-item-paste-tooltip-empty cms-hover-tooltip cms-hover-tooltip-left cms-hover-tooltip-delay" data-cms-tooltip="{% trans "El poratapapeles está vacío." %}"></span>
                    <span class="cms-submenu-item-paste-tooltip cms-submenu-item-paste-tooltip-restricted cms-hover-tooltip cms-hover-tooltip-left cms-hover-tooltip-delay" data-cms-tooltip="{% trans "Este plugin no permite añadir ese tipo de plugins anidados." %}"></span>
                    <span class="cms-submenu-item-paste-tooltip cms-submenu-item-paste-tooltip-disabled cms-hover-tooltip cms-hover-tooltip-left cms-hover-tooltip-delay" data-cms-tooltip="{% trans "Este plugin no puede tener plugins anidados." %}"></span>
                </div>
                <div class="cms-submenu-item"><a data-cms-icon="bin" data-rel="delete" href="#">{% trans "Eliminar" %}</a></div>
                {% render_extra_menu_items plugin %}
            </div>
        </div>
        {% if not clipboard %}
            <div class="cms-plugin-picker" data-touch-action="pan-y">
                <div class="cms-quicksearch"><label><input type="text" placeholder="{% trans 'Filtrar plugins...' %}" /></label></div>
