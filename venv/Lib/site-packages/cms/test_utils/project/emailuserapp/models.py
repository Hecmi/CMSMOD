...
class AbstractEmailUser(AbstractBaseUser, PermissionsMixin):
    ...
    email = models.EmailField(
        ...
        blank=True,
        unique=True,
        help_text="Requerido.  Ingre un email con formato de correo."
    )
    ...
    is_staff = models.BooleanField(
        'staff status',
        default=False,
        help_text='Designa los usuarios que podrán acceder al menú de adminsitración.'
    )

    is_active = models.BooleanField(
        'active',
        default=True,
        help_text='Asigna los usuarios que pueden acceder o no al sistema. Deshabilitar en lugar de eliminar los usuarios.'
    )
